    ...
    <div class="container">
        ...
        <div class="row content">
            <div class="col-4 linkcont">
                <ul class="post-title">
                    ...
                    <li><a href="battlenet.php" class="post active">BATTLE.NET</a></li>
        ...
        <div class="row footer">
            ...
            <div class="col-4 copyright">
                PUBLISHER: BLIZZARD ENTERTAINMENT <img src="kepek/blizzardlogo.png" class="small-img" alt="Microsoft corp">
            </div>
